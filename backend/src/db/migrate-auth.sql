-- Run once on existing databases that still have Spotify OAuth user columns
...
-- Fresh dev DB: drop old users if Spotify-only schema blocks migration
-- Comment out DROP if you need to preserve data
